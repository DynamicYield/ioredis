...
function Pipeline(redis) {
  ...
  _.keys(redis.scriptsSet).forEach(function (name) {
    ...
    _this[name + 'String'] = redis[name + 'String'];
  });
...
var execString = Pipeline.prototype.execString;
Pipeline.prototype.execString = function () {
  if (this._transactions > 0) {
    this._transactions -= 1;
  }
  return execString.apply(this, arguments);
};
